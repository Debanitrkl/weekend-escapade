...
2. Tests/lint/typecheck/build (as relevant) pass or you have a documented reason they were not run.
3. Risky changes have a rollback/flag strategy (when applicable).
4. The code follows existing conventions and is readable.
5. A short verification story exists: "what changed + how we know it works."
